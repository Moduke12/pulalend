  ...
  return (
    <DashboardLayout userType="admin" navItems={navItems} title="KYC Review">
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 className="text-lg font-bold text-navy-deep mb-2">KYC Review</h2>
        <p className="text-gray-600">
          KYC upload/review endpoints are the next step (FR-006 to FR-008). This page is wired into navigation so we can add document review here next.
        </p>
      </div>
    </DashboardLayout>
  );
