                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                      ...
                      <div className="text-xl font-bold text-navy-deep mt-1">
                        P{Number(l.amount).toLocaleString()} at {l.interestRate}% for {l.durationMonths} months
                      </div>
                      <div className="text-gray-600 mt-2 line-clamp-2">{l.purpose}</div>
                      <div className="text-sm text-gray-500 mt-2">
                        Funded: P{Number(l.fundedAmount).toLocaleString()} • Remaining: P{Number(l.remainingAmount).toLocaleString()}
                      </div>
                    </div>
