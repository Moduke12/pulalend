        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-10 flex-1 flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="text-right mt-1.5">
                  <Link href="/" className="text-sm text-primary-blue hover:text-blue-700 font-medium">
                    Forgot Password?
                  </Link>
                </div>
              </div>
            ...
            <div className="space-y-3">
              <button type="button" className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition text-sm font-medium text-gray-700">
